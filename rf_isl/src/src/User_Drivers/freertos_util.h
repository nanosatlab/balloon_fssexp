...
/**
 * Internal notifications between FreeRTOS tasks:
 * - GDO_NOTIFY_GDO0
 * - GDO_NOTIFY_GDO2
 * - COMMS_NOTIFY_SEND_REQ
 * - COMMS_NOTIFY_PHY_RECEIVED
 * - COMMS_NOTIFY_END_TX
 * - COMMS_NOTIFY_RESET
 * - IFACE_NOTIFY_TX_END
 * - IFACE_NOTIFY_TX_REQ
 ...
 * - CTRL_WDT_COMMS_TX_RESET
 * - CTRL_WDT_COMMS_RESET
 * - CTRL_WDT_INTERFACE_TX_RESET
 */
...
#define COMMS_NOTIFY_SET_FREQ			(1 << 6)
...
#define CTRL_HK_POWER_MEASURE			(1 << 4)
#define CTRL_NEW_PACKET					(1 << 5)
