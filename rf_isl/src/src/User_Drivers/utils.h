...
#define LNA_EN_Pin GPIO_PIN_14
#define LNA_EN_GPIO_Port GPIOB
#define SUPPLY_3V_EN_Pin GPIO_PIN_15
#define SUPPLY_3V_EN_GPIO_Port GPIOB
#define SUPPLY_3V3_EN_Pin GPIO_PIN_13
#define SUPPLY_3V3_EN_GPIO_Port GPIOB
#define PM_EN_Pin GPIO_PIN_7
#define PM_EN_GPIO_Port GPIOB
#define PM_VMRS_Pin GPIO_PIN_0
#define PM_VMRS_GPIO_Port GPIOC
